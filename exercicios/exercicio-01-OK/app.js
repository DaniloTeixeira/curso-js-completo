...
*/
console.log(myByrthYear, currentYear);
...
*/
const myAge = currentYear - myByrthYear;
console.log(myAge);
...
*/
const ten = 10;
console.log(`Em ${currentYear + ten}, estarei com ${myByrthYear + ten} anos.`);
...
document.querySelector('#birthYear').value = myBirthdayYear
