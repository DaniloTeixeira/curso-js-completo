...
dogNames.push("Nina");
const initials = `${dogNames[0][0]}${dogNames[1][0]}${dogNames[2][0]}${dogNames[3][0]}`; // segunda opção
// const initials = `${dogNames[0].slice(0, 1)} ${dogNames[1].slice(0, 1)} ${dogNames[2].slice(0, 1)} ${dogNames[3].slice(0, 1)}` // primeira opção
